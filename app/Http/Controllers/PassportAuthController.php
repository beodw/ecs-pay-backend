...
class PassportAuthController extends Controller
{
    ...
    */
    public function register(RegisterUserRequest $request)
    {
        ...
        try {
            $otp = rand(1000,9999);
            $message = "Thank you for using ECS Pay. This is your signup otp: $otp. If this request was not generated by you please reset your password as soon as possible.";
        ...
        OTPCollection::create(['otp' => $otp, "phone" => $phone_number, "created_at" => date(DATE_ATOM, time())]);
    ...
    *       @OA\Property(property="otp", type="number", format="string", example="9999"),
    *       @OA\Property(property="whatsapp_number", format="phone", type="string", example="0502342345"),
    *       @OA\Property(property="country_code", type="string", example="GH"),
    *    ),
    * ),
    ...
    */
    public function verifyOtp(VerifyOtpRequest $request){
       //find user with whatsapp and country code and otp
        ...
        $countryCode = CountryCode::where("code", $request->country_code)->firstOrFail();
       
        //add country code to phone number string.
        $phone_number = "".$countryCode['dial_code']; 
        
        // concatenate number without inital zero.
        $phone_number = $phone_number.$request->whatsapp_number;

        $otp = OTPCollection::where("phone", $phone_number)
                        ->where("otp", $request->otp)
                        ->firstOrFail();
        //check that otp has not expired
        // return response()->json(["otp"=> date(DATE_ATOM, time()) ]);
